...
function getData() {
  axios.all([axios.get('https://jsonplaceholder.typicode.com/todos?_limit=5'), axios.get('https://jsonplaceholder.typicode.com/posts?_limit=5')]).then(function (res) {
    console.log(res[0]);
    console.log(res[1]);
    showOutput(res[1]);
  });
...
axios.defaults.headers.common['X-Auth-Token'] = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c'; // CUSTOM HEADERS
...
//# sourceMappingURL=/axios.e31bb0bc.js.map